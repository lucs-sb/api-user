...
[TestFixture]
public sealed class UpdateUserModelValidatorTests
{
    ...
    private static UpdateUserModel ValidModel(
        string? name = "Teste",
    ...
    {
        var model = new UpdateUserModel(Name: "Teste", Email: "teste@email.com", BirthDate: null);
        var result = _validator.TestValidate(model);
